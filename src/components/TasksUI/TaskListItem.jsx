        ...
        >
            ...
            <Container display='flex' justifyContent='space-between' alignItems='center'>
                ...
                <Container display='flex' alignItems='end'>
                    <ViewColumnRoundedIcon style={{'fontSize':'20px', 'color':'#5E6569', 'marginRight':'2px'}}/>
                ...
                <Container marginTop='2%' display='flex' justifyContent='flex-end'>
                    ...
                    <Container marginRight='20px'>
                        <Tooltip title='Workers quantity'>
                            <GroupIcon style={{'fontSize':'20px', 'color':'#5E6569', 'marginRight':'2px'}}/>
                        </Tooltip>
                        <Text fontSize='12px' color='#4279E0'>{task.workers.length}</Text>
                    </Container>

                    <Container marginRight='20px'>
                        <Tooltip title='Task items quantity'>
                            <SegmentIcon style={{'fontSize':'20px', 'color':'#5E6569', 'marginRight':'2px'}}/>
                        </Tooltip>  
                        {task.task_items
                            ?<Text fontSize='12px' color='#4279E0'>{task.task_items.length}</Text>
                            :<Text fontSize='12px' color='#4279E0'>0</Text>
                        }
                    </Container>
